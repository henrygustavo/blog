namespace Blog.Business.Logic.Implementations
{
	...
	public class BlogEntryTagBL : IBlogEntryTagBL
	{
		private readonly IBlogEntryTagRepository _repository;
		private readonly ICommonRepository _commonRepository;

		public BlogEntryTagBL(IBlogEntryTagRepository repository, ICommonRepository commonRepository)
		{
			_repository = repository;
			_commonRepository = commonRepository;
		}

		public BlogEntryTag Get(int id)
		{
			return _repository.Get(id);
		}

		[UnitOfWork]
		public IList<BlogEntryTag> GetAll()
		{
		...
		public List<BlogEntryTag> GetAll(List<FilterOption> filters, int pageNumber, int pageSize, string sortBy, string sortDirection, List<string> selectColumnsList = null)
		{
		...
		public void Insert(BlogEntryTag entity)
		{
