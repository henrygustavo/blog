namespace Blog.Business.Logic.Interfaces
{
    ...
    public interface IUserBL : IBaseLogic<User>
    {
  User GetByUserName(string userName);
        ...
        List<UserView> GetAllView(List<FilterOption> filters, int pageNumber, int pageSize, string sortBy, string sortDirection, List<string> selectColumnsList = null);
