...
var applicationModule = angular.module("applicationModule", ['ui.router', 'ngResource', 'ngRoute', 'ngAnimate', 'ui.bootstrap', 'blockUI', 'ngMessages']);

applicationModule.config(function ($urlRouterProvider, $stateProvider, $locationProvider, GlobalInfo, blockUIConfig) {
