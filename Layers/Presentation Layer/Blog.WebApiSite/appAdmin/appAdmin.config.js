...
var applicationModule = angular.module("applicationAdminModule",
    [
        "ui.router",
        "ngMessages",
        "satellizer",
...
applicationModule.config(function($urlRouterProvider,
            ...
            .state("home",
                {
                    ...
                    authenticate: true,
                    data: {
                        permissions: { only: ["AUTHORIZED"], redirectTo: "login" }
                    }
                })
            .state("login",
                {
            ...
            .state("userEdit",
                {
                    ...
                    data: {
                        permissions: { only: ["ADMIN"], redirectTo: "accessDenied" }
                    }
                })
            .state("userDetail",
                {
            ...
            .state("personalInformationEdit",
                {
                    ...
                    data: {
                        permissions: { only: ["AUTHORIZED"], redirectTo: "accessDenied" }
                    }
                })
        ...
        inputTextConfigProvider.setValidationMessagePath("/appAdmin/shared/html/validation-messages.html");
    })
    .constant("GlobalInfo",
        {
            apiUrl: "/api",
    ...
    .run(function(PermRoleStore, authManager, $rootScope, $state) {
        ...
        PermRoleStore.defineRole("ANONYMOUS",
            function(stateParams) {
                return authManager.isAnonymous();
            });

        PermRoleStore.defineRole("AUTHORIZED",
            function(stateParams) {
                return !authManager.isAnonymous();
            });
