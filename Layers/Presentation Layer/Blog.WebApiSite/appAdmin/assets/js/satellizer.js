    ...
    angular.module('satellizer', [])
        ...
        function ($q, $http, popup, config, utils) {
            return function () {
                ...
                Oauth1.open = function (options, userData) {
                    ...
                    var popupWindow = popup.open(serverUrl, defaults.name, defaults.popupOptions).pollPopup();

                    return popupWindow
                      .then(function (oauthData) {
                          return $http.post(defaults.registerLoginUri, oauthData);
      ...
      .factory('SatellizerPopup', [
        ...
        function ($q, $interval, $window, config, utils) {
            ...
            Popup.eventListener = function () {
                var deferred = $q.defer();

                Popup.popupWindow.addEventListener('message', function (event) {
